  ...
  return (
    <div className=" overflow-hidden max-md:[transform:scale(0.7)] xl:[transform:scale(1.1)] xl:mt-[20px] flex items-center justify-center bg-black relative w-[1000px] h-[600px]
      ...
      <div id ='moon-orbit' className="absolute w-[350px] h-[200px] [border-radius:50%] border border-white 
                                        [border-width:0.1rem_0.1rem_0_0] [transform:rotateX(100deg)]">
      </div>
      ...
      <div id='mars' 
           ...
           className=" absolute w-[50px] h-[50px] bg-yellow-700 rounded-full shadow-[0_0_10px_white]
                                ...
                                [offset-rotate:0deg]
                                [offset-path:path('M225_0_A225_75_0_1_1_-225_0_A225_75_0_1_1_225_0')]
                                [animation:orbit_18s_linear_infinite,getSmall_18s_linear_infinite]">
      ...
      <div id = 'earth' 
          ...
          className="absolute w-[25px] h-[25px] bg-sky-500 rounded-full shadow-[0_0_10px_white] 
                                  [offset-path:path('M125_0_A125_50_0_1_1_-125_0_A125_50_0_1_1_125_0')]
                                  [offset-rotate:0deg]
                                  flex items-center justify-center
                                  [animation:orbit_10s_linear_infinite,getSmall_10s_linear_infinite]">
        ...
        <div id='moon' 
            style={{ animationPlayState: paused ? 'paused' : 'running' }} 
            className=" absolute w-2 h-2 bg-white rounded-full shadow-[0_0_10px_white] 
                                  [offset-path:path('M0_25_A8.7_25_0_1_1_0_-25_A8.7_25_0_1_1_0_25')] 
                                  [offset-rotate:0deg]
                                  [animation:orbit_4s_linear_infinite,hidden_4s_linear_infinite]
                                  ">
      ...
      <div  id='jupiter' 
            ...
            className=" absolute w-[70px] h-[70px] bg-stone-600 rounded-full shadow-[0_0_10px_white]
                                  flex items-center justify-center
                                  [offset-rotate:0deg]
                                  [offset-path:path('M375_0_A375_47.24_0_1_1_-375_0_A375_47.24_0_1_1_375_0')]
                                  [animation:orbit_25s_linear_infinite,getSmall_25s_linear_infinite]">
